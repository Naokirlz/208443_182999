...
namespace Interfaz.Contrasenias
{
    public partial class ModificarContrasenias : UserControl
    {
        ...
        private void Refrescar()
        {
            ...
            bSource2.DataSource = this.Sesion.GestorContrasenia.ListarContrasenias();
        ...
        private void CargarDatosContrasenia()
        {
            ...
            if (contraseniaSeleccionada != null)
            {
                ...
                this.txtPassword.Text = Sesion.GestorContrasenia.MostrarPassword(contraseniaSeleccionada.Password);
            }
